...
def evaluation_ABC(exp, dataset, classifier, N):
    aData = []
    sData = []
    dData = []
    dDataPercent = []
    ...
    f = open("RSUTT/" + exp + "/" + dataset + "_" + classifier + "_" + N + ".txt")
    ...
    with open("RSUTT/" + exp + "/" + dataset + "_" + classifier + "_" + N + "_" + "evaluation.txt", "w") as myfile:
        myfile.write("Total evaluated data:\n"
                         + str(float(sum(aData) / len(aData))) + " "
                         + str(np.std(aData)) + " "
                         + str(max(aData)) + " "
